...
class NeRFSystem(pl.LightningModule):
    def __init__(self, hparams):
        super().__init__()
        # In 2.5.0, save_hyperparameters() needs a direct dict/namespace
        self.save_hyperparameters(vars(hparams))
        self.hparams.update(vars(hparams))  # Ensure backward compatibility
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Updated logging syntax for 2.5.0
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if batch_idx == 0:
            ...
            # Updated logging for images in 2.5.0
            self.logger.experiment.add_images('val/GT_pred_depth',
                                           stack, self.global_step)

        psnr_ = psnr(results[f'rgb_{typ}'], rgbs)
        
        # Return dict format for validation_step in 2.5.0
...
def main(hparams):
    ...
    trainer = pl.Trainer(
        ...
        # resume_from_checkpoint replaced with new parameter
        enable_checkpointing=True,
        logger=logger,
        # weights_summary removed in 2.5.0
        ...
        benchmark=True,
        # profiler updated for 2.5.0
        profiler="simple" if hparams.num_gpus == 1 else None,
        # Added default parameters for 2.5.0
        precision='32',
